...
from app.schemas.character_schema import CharacterCreate, CharacterUpdate

from . import character_crud


# insert
def create_character(character: CharacterCreate, user_id: int, db: Session):
    return character_crud.create_character(character, user_id, db)
